"""
Model loader for the Medical Terminology Mapper.
This module handles loading, initialization, and management of the biomedical language model.
Adapted from the Clinical Protocol Extractor project with terminology-specific adjustments.
"""
...
class ModelManager:
    ...
    def __init__(self, model_path=None):
        ...
        Args:
            model_path (str, optional): Path to NER model directory. Defaults to None,
