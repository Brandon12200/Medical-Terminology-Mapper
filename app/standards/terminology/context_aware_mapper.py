"""
Context-Aware Terminology Mapper for Medical Terminology Mapper.

This module provides advanced context-aware mapping capabilities that consider
clinical context, domain specificity, and semantic relationships to make
more intelligent terminology mapping decisions.

Week 6 Implementation - Context-Aware Mapping
"""
...
class ClinicalDomain(Enum):
    """Clinical domain classifications for context-aware mapping."""
...
class ContextModifier(Enum):
    """Context modifiers that affect mapping decisions."""
    NEGATION = "negation"
...
class ClinicalContext:
    """Represents the clinical context for a term mapping."""
...
class ContextAwareMapping:
    """Enhanced mapping result with contextual information."""
    original_text: str
    found: bool
    system: Optional[str]
    code: Optional[str]
...
class ContextAwareTerminologyMapper:
    """
    Advanced terminology mapper with context awareness.
    
    This mapper enhances the base terminology mapping with:
    - Clinical domain detection
    - Context modifier recognition
