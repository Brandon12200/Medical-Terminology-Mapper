...
This module provides the core functionality for mapping medical terms to
...
class TerminologyMapper:
    """
    Maps medical terms to standard terminologies (SNOMED CT, LOINC, RxNorm).
    
    This class provides methods to map extracted medical terms to standardized
    ...
    Attributes:
        ...
        clinical_context_enhancers: Dictionary of context enhancement methods
    """
    ...
    def _setup_fuzzy_matching(self):
        ...
        if self.config.get("use_fuzzy_matching", True):
            try:
                # Determine if we should use the sophisticated fuzzy matcher or a simpler one
    ...
    def _setup_external_services(self):
        ...
        # External services are optional for the Medical Terminology Mapper
        # but we'll keep the structure for future extensions
        if self.config.get("use_external_services", False):
            try:
                # This would be implemented in future phases as needed
    ...
    def _load_all_synonyms(self):
        """Load all synonym dictionaries from the synonyms directory."""
        try:
    ...
    def _setup_clinical_context_enhancers(self):
        """Set up context enhancement methods for medical terminology."""
        # Dictionary mapping context types to enhancement functions
        self.clinical_context_enhancers = {
    ...
    def _enhance_medical_context(self, term: str, mapping_result: Dict[str, Any], context: str) -> Dict[str, Any]:
        """
        Enhance mapping results for general medical terms based on context.
        ...
        """
        # Check for medical keywords in the context
        medical_keywords = [
        ...
        # Check if the context contains any medical keywords
        medical_context = any(kw in context.lower() for kw in medical_keywords)
        
        if medical_context:
            # Increase confidence score if in a medical context
    ...
    def _enhance_condition_context(self, term: str, mapping_result: Dict[str, Any], context: str) -> Dict[str, Any]:
        """
        Enhance mapping results for medical conditions based on context.
        ...
        Returns:
            Enhanced mapping result
        """
        # Check for condition-specific keywords in the context
        condition_keywords = [
        ...
        # Check if the context contains any condition-specific keywords
        condition_context = any(kw in context.lower() for kw in condition_keywords)
        
        if condition_context:
            # Increase confidence score if in a condition context
            if "score" in mapping_result:
    ...
    def _enhance_procedure_context(self, term: str, mapping_result: Dict[str, Any], context: str) -> Dict[str, Any]:
        """
        Enhance mapping results for procedure terms based on context.
        ...
        Returns:
            Enhanced mapping result
        """
        # Check for procedure-specific keywords in the context
        procedure_keywords = [
        ...
        # Check if the context contains any procedure-specific keywords
        procedure_context = any(kw in context.lower() for kw in procedure_keywords)
        
        if procedure_context:
            # Increase confidence score if in a procedure context
            if "score" in mapping_result:
    ...
    def _enhance_medication_context(self, term: str, mapping_result: Dict[str, Any], context: str) -> Dict[str, Any]:
        """
        Enhance mapping results for medication terms based on context.
        ...
        Returns:
            Enhanced mapping result
        """
        # Check for medication-specific keywords in the context
        medication_keywords = [
        ...
        # Check if the context contains any medication-specific keywords
        medication_context = any(kw in context.lower() for kw in medication_keywords)
        
        if medication_context:
            # Increase confidence score if in a medication context
            if "score" in mapping_result:
                mapping_result["score"] = min(100, mapping_result["score"] + 15)
            mapping_result["context_enhanced"] = True
    ...
    def _enhance_lab_test_context(self, term: str, mapping_result: Dict[str, Any], context: str) -> Dict[str, Any]:
        """
        Enhance mapping results for laboratory test terms based on context.
        ...
        Returns:
            Enhanced mapping result
        """
        # Check for lab test-specific keywords in the context
        lab_keywords = [
