"""
Logging utilities for the Medical Terminology Mapper.

This module provides a set of functions to set up logging for different
components of the application with consistent formatting and behavior.
"""
